...
export default function Cart() {
  ...
  const choosenPurchaseIdFromLocation = (location.state as { purchaseId: string | number })?.purchaseId

  const delelePurchasesMutation = useMutation({
  ...
  const handleDelete = (purchaseIndex: number) => () => {
    ...
    delelePurchasesMutation.mutate([purchaseId])
  }

  const handleDeleteManyPurchases = () => {
    const purchasesIds = checkedPurchases.map((purchase) => purchase._id)
    delelePurchasesMutation.mutate(purchasesIds)
  }
                          ...
                          <div className='grid grid-cols-5 items-center'>
                            <div className='col-span-2'>
                              <div className='flex items-center justify-center'>
                                ...
                                <span className='ml-3 text-red-600'>₫{formatCurrency(purchase.product.price)}</span>
                              </div>
                            </div>
